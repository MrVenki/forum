    ...
    <div className="w-full max-w-md">
      <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-lg">
        <div className="mb-8 text-center">
          <h1 className="font-heading text-2xl font-bold text-navy-500">Welcome back</h1>
          <p className="mt-1 text-sm text-neutral-500">Sign in to your IndiaPropertyTalk account</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-neutral-500">
          ...
          <Link href="/register" className="font-semibold text-saffron-500 hover:text-saffron-600 transition-colors">
            Create one free
          </Link>
        </div>
      </div>
